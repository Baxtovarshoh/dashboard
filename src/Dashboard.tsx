      ...
      <div className="relative z-10 w-[96%] h-full gap-6 bg-neutral-300/50 border border-indigo-600 rounded-4xl flex p-5 ">
        ...
        <div className="w-[89%]  space-y-5 rounded-2xl ">
          ...
          <div className="w-full flex  h-[40%] gap-5">
            <div className="w-[85%] cursor-pointer bg-white rounded-2xl flex justify-center gap-2 flex-col px-5 py-2">
              <HeaderTextLine />
              <div className="w-[99%]  h-3/4">
                <Line />
              </div>
            </div>
            <CardHold />
          ...
          <div className=" flex gap-5 h-[40%]">
            <div className="w-4/6 flex gap-5">
              <div className="w-1/2 cursor-pointer  p-3 bg-white space-y-1.5 rounded-2xl">
                <CardSoldHeader />
              ...
              <div className=" cursor-pointer  bg-white rounded-2xl p-3 flex flex-col gap-5 w-[47%]">
                <CardDiag />
